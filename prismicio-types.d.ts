...
export interface BiographySliceDefaultPrimary {
  ...
  /**
   * test field in *Biography → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: biography.default.primary.test
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
export interface ContactSliceDefaultPrimary {
  /**
   * from_name field in *Contact → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: contact.default.primary.from_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  from_name: prismic.KeyTextField;
  ...
  /**
   * Template Id field in *Contact → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: contact.default.primary.template_id
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  template_id: prismic.KeyTextField;

  /**
   * Public Key field in *Contact → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: contact.default.primary.public_key
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  public_key: prismic.KeyTextField;

  /**
   * service_id field in *Contact → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: contact.default.primary.service_id
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
/**
 * Item in *Experience → Default → Primary → Work Experience*
 */
export interface ExperienceSliceDefaultPrimaryWorkItem {
  /**
   * Start Date field in *Experience → Default → Primary → Work Experience*
   *
   * - **Field Type**: Date
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.work[].start_date
   * - **Documentation**: https://prismic.io/docs/field#date
   */
  start_date: prismic.DateField;

  /**
   * End Date field in *Experience → Default → Primary → Work Experience*
   *
   * - **Field Type**: Date
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.work[].end_date
   * - **Documentation**: https://prismic.io/docs/field#date
   */
  end_date: prismic.DateField;

  /**
   * Company Name field in *Experience → Default → Primary → Work Experience*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.work[].company_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  company_name: prismic.KeyTextField;

  /**
   * Description field in *Experience → Default → Primary → Work Experience*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.work[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;

  /**
   * Company Image field in *Experience → Default → Primary → Work Experience*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.work[].company_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  company_image: prismic.ImageField<never>;

  /**
   * Position field in *Experience → Default → Primary → Work Experience*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.work[].position
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
export interface ExperienceSliceDefaultPrimary {
  /**
   * Work Experience field in *Experience → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.work[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  work: prismic.GroupField<Simplify<ExperienceSliceDefaultPrimaryWorkItem>>;
}
...
export interface TechListSliceDefaultPrimaryItemsItem {
  ...
  /**
   * logo field in *TechList → Default → Primary → Items*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.items[].logo
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  logo: prismic.ImageField<never>;
}
...
/**
 * Item in *TextBlock → Default → Primary → image_group*
 */
export interface TextBlockSliceDefaultPrimaryImageGroupItem {
  /**
   * image field in *TextBlock → Default → Primary → image_group*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_block.default.primary.image_group[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
export interface TextBlockSliceDefaultPrimary {
  ...
  /**
   * image_group field in *TextBlock → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: text_block.default.primary.image_group[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  image_group: prismic.GroupField<
    Simplify<TextBlockSliceDefaultPrimaryImageGroupItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ExperienceSlice,
      ExperienceSliceDefaultPrimaryWorkItem,
      ...
      TextBlockSlice,
      TextBlockSliceDefaultPrimaryImageGroupItem,
